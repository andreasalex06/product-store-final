...
<body class="bg-light">
    ...
    <div class="container min-vh-100 d-flex align-items-center justify-content-center">
        <div class="row w-100 shadow shadow-sm border border-3 rounded-3 overflow-hidden bg-white"
            ...
            <div class="col-md-6 d-none d-md-block position-relative p-0">
                ...
                {{-- Text --}}
                <div class="position-absolute top-50 start-50 w-75 translate-middle text-white text-center ">
